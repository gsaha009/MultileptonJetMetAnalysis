#ifndef __MultiLeptonCUTAna__hh
#define __MultiLeptonCUTAna__hh
...
class MultiLeptonCUTAna: public PhysicsObjSelector {
...
private:
  ...
  std::vector<vhtm::GenJet>GenJets;
  std::vector<vhtm::GenParticle> GenLeptons;
  std::vector<vhtm::GenParticle> GenMet;
  ...
  std::unique_ptr<GenAnaBase> genAna_ {nullptr}; //GenObject
